...
```{r PlotEnv}
topn <- 50    # number of genes to examine
```
...
Samples were grouped by conditions (cellline, timepoint). All couples were compared gene expression fold change, and most significant ``r topn`` genes were seleced. Selected genes are as follows.

<!--- Write findings about selected genes -->
